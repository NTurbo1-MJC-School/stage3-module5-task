...
public class UpdateCommentCommand implements Command {
    ...
    @Autowired
    public UpdateCommentCommand(@Qualifier("commentController") CommentControllerInterface commentController) {
