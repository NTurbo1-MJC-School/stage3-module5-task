...
public class DeleteCommentCommand implements Command {
    ...
    @Autowired
    public DeleteCommentCommand(@Qualifier("commentController") CommentControllerInterface commentController) {
    ...
    @Override
    public void execute() {
        System.out.println(Operations.REMOVE_COMMENT_BY_ID.getOperation());
        ...
        try {
            ...
            System.out.println(CommandHelper
                    .findCommandHandlerFor(Operations.REMOVE_COMMENT_BY_ID.getOperationNumber(), commentController)
